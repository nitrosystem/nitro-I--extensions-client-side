(function (root, factory) {
    ...
    window.bEngineApp.directive('ckeditor', ['$parse', ckeditorDirective]);
        ...
        return {
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                controller.ready().then(function initialize() {
                    ...
                    ['dataReady', 'change', 'blur', 'saveSnapshot', 'key', 'paste', 'selectionChange'].forEach(function (event) {
    ...
    function ckeditorController($scope, $element, $attrs, $parse, $q) {
        ...
        config.allowedContent = true;   //temp by norouzi
